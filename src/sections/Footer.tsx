import { Phone, Mail, Clock, Instagram, ArrowUp } from 'lucide-react';
...
export function Footer({ onCategorySelect }: FooterProps) {
  ...
  const socialLinks = [
    ...
    {
      icon: WhatsAppIcon,
      href: `https://wa.me/${whatsappConfig.phoneNumber}?text=${encodeURIComponent(whatsappConfig.defaultMessage)}`,
      label: 'WhatsApp',
    },
  ];
