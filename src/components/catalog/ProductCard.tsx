...
export function ProductCard({
  ...
  const hasRealImage = Boolean(product.cloudinary_url);
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-[#F0EAE2] flex-shrink-0">
        {/* Hover overlay — solo sobre la imagen */}
        ...
        {hasRealImage ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-[#EDEBE5]">
            <Package className="w-10 h-10 text-[#C8BFB5]" />
          </div>
        )}
